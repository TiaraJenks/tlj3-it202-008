...
<?php if (isset($pokemon)) : ?>
    ...
    <div class="card mx-auto" style="width: 18rem;">
        ...
        <div class="card-body">
            <h5 class="card-title"><?php se($pokemon, "name", "Unknown"); ?> (<?php se($pokemon, "rarity"); ?>)</h5>
            <div class="card-text">
                <ul class="list-group">
            ...
            <?php if(!isset($pokemon["user_id"]) || $pokemon["user_id"] === "null"):?>
            <div class="card-body">
                <a href="<?php echo get_url(('api/purchase_pokemon.php?poke_id=' . $pokemon["id"]));?>" class="card-link">Purchase Pokemon</a>
            </div>
            <?php else:?>
                <div class="card-body">
                    <div class="bg-danger text-light"> Pokemon is no longer available</div>
                </div>
            <?php endif;?>           
        </div>
    </div>
